...
cursor = db.cursor() 
cursor.execute("""
                SELECT DISTINCT br.birth_rate/1000 AS birth_rate, ed.percent_less_hs AS percent_less_hs, br.year, br.fips 
                FROM f22_group5.birth br JOIN f22_group5.education_less_hs ed ON br.fips=ed.fips ORDER BY br.year DESC;""") 
